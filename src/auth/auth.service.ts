...
export class AuthService {
    ...
    async login(user: IUser,response: Response) {
        const { _id, name, email, role,company, permissions,isActive,age,address,avatar } = user; 
        const payload = {
        sub: "token login",
        iss: "from server",
        _id, name, email, role,company,isActive,age,address,avatar
        };
        ...
        return {
            // data:{
                ...
                refreshToken,
                  user: {
                            _id, name, email, role,company,permission:temp?.permissions??[],isActive,age,address,avatar
                         }     
        // }
        };
    }
